...
import { Subscription, DummyConfig, extractConfigsList } from "@/lib/v2ray";
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400 font-mono">
              Vercel Key-Value (Upstash Redis) or Local Persistence Mode
            </p>
          </div>
        </div>
              ...
              <div id="section_core_settings" className="bg-slate-950 p-6 rounded-2xl border border-slate-800 space-y-5">
                ...
                <div className="bg-slate-900 rounded-xl border border-slate-800 p-4 space-y-3.5">
                  ...
                  <p className="text-[11px] text-slate-400 leading-relaxed">
                    Clients such as <strong>V2RayN</strong>, <strong>Shadowrocket</strong>, <strong>v2rayNG</strong> or <strong>v2fly</strong> query this URL dynamically to obtain up-to-date active nodes without manual intervention!
                  </p>
                </div>
              </div>
